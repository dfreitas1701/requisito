...
--
-- Host: localhost    Database: redbelt
-- ------------------------------------------------------
...
INSERT INTO `criticidade` VALUES (1,'Alta'),(2,'Média'),(3,'Baixa');
...
CREATE TABLE `incidente` (
  ...
  `criticidade_id` tinyint(3) unsigned NOT NULL,
  `tipoincidente_id` tinyint(3) unsigned NOT NULL,
  `status` varchar(1) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`,`criticidade_id`,`tipoincidente_id`),
  KEY `fk_incidente_criticidade_idx` (`criticidade_id`),
  KEY `fk_incidente_tipoincidente1_idx` (`tipoincidente_id`)
...
INSERT INTO `migrations` VALUES (1,'2014_10_12_000000_create_users_table',1),(2,'2014_10_12_100000_create_password_resets_table',1),(3,'2019_05_13_150519_create_incidente_table',1);
...
INSERT INTO `tipoincidente` VALUES (1,'Ataque Brute Force'),(2,'Credenciais vazadas'),(3,'Ataque de DDos'),(4,'Atividades anormais de usuários');
...
-- Dump completed on 2019-05-15 13:44:28
